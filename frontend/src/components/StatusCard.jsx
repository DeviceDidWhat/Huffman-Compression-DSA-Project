        ...
        return (
          <div className="status-content idle">
            ...
            <div className="status-text">
              ...
              <p className="status-message">Select a file to begin compression or decompression</p>
            </div>
          </div>
        );
        ...
        return (
          <div className="status-content success">
            ...
            <div className="status-text">
              ...
              <p className="status-message">Your file has been processed successfully</p>
            </div>
          </div>
        );
        ...
        return (
          <div className="status-content error">
            ...
            <div className="status-text">
              ...
              <p className="status-message error-message">{error || 'Something went wrong'}</p>
            </div>
